...
Pod::Spec.new do |spec|
  ...
  #spec.dependency "FBSDKCoreKit", '~> 12.0.0'
  #spec.dependency "FBSDKLoginKit", '~> 12.0.0'
  #spec.dependency "FBSDKShareKit", '~> 12.0.0'
  #spec.dependency "FBSDKGamingServicesKit", '~> 12.0.0'
...
# ============================== END ShareSDK ==============================
  ...
  spec.dependency 'CTAssetsPickerController',  '~> 3.3.0'
